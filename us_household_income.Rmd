...
```
We failed to reject the null hypothesis. A p-value of 0.9285 indicates that the probability of observing our test statistic p = 0.4997135 is 93% given the null-hypothesis is true.
...
```
95% confident interval is [747.1329, 5865.2244]. P-value is equal to 0.0114, at a 0.05 significance level we fail to reject the null hypothesis: the true difference in means is not equal to 0. This agrees with our conficence inteval since 0 is not within it.
